local self 					= {}
local pairs					= pairs
local importedManagement 	= NetBoltGateAway ["NetBoltGateAway:Initializer"]

function self:InternalId ()
	return "NetBoltGateAway:ProgramLogs"
end
...
function self:Constructor ()
	...
	self.FunctionLoggerInternal = NetBoltGateAway ["NetBoltGateAway:SystemDispatcher"].WeakKeys ()
	...
	self.DataPathMain = "netbolt-gateaway"
	...
	importedManagement:MiniLogger ("NetBoltGateAway:ProgramLogs ran successfully.")
end
